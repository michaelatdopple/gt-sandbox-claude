...
*/
    ...
    /**
     * Set the SDL surface for fragment mode (no SDLActivity instance).
     * Called by Love2dGameFragment before starting the Love2D thread.
     */
    public static void setFragmentSurface(SDLSurface surface) {
        mSurface = surface;
    }
    ...
    public static boolean setActivityTitle(String title) {
        ...
        if (mSingleton == null) return false; // Fragment mode: no Activity to set title on
    ...
    public static void setWindowStyle(boolean fullscreen) {
        // Called from SDLMain() thread and can't directly affect the view
        if (mSingleton == null) return; // Fragment mode
