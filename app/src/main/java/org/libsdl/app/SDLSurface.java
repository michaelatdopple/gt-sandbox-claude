...
public class SDLSurface extends SurfaceView implements SurfaceHolder.Callback,
    ...
    public void surfaceChanged(SurfaceHolder holder,
        ...
        // Fragment mode: mSingleton is null but we still need to tell SDL the screen size.
        // Skip the context synchronization (used for fullscreen toggle, N/A in fragment mode).
        ...
        // Orientation skip check requires mSingleton (SDLActivity instance).
        // In fragment mode, skip this check — the fragment manages its own orientation.
        boolean skip = false;
